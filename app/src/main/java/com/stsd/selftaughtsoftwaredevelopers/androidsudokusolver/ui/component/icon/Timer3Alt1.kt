    ...
    get() {
        ...
        _timer3Alt1 = materialIcon(name = "Timer3Alt1") {
            materialPath() {
                ...
                quadToRelative(0.625f, -0.538f, 0.625f, -1.288f)
                verticalLineToRelative(-1.3f)
                quadToRelative(0.0f, -0.575f, -0.462f, -0.963f)
                quadToRelative(-0.463f, -0.387f, -1.113f, -0.387f)
                quadToRelative(0.65f, 0.0f, 1.113f, -0.4f)
                quadToRelative(0.462f, -0.4f, 0.462f, -0.975f)
                verticalLineToRelative(-0.8f)
                quadToRelative(0.0f, -0.75f, -0.625f, -1.275f)
                quadToRelative(-0.625f, -0.525f, -1.5f, -0.525f)
                lineTo(8.95f, 8.775f)
...
@Preview
@Composable
fun Timer3Alt1Preview() {
    Icon(
        imageVector = Timer3Alt1,
        contentDescription = Timer3Alt1.name
    )
}